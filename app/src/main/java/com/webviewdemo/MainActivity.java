...
import com.webviewdemo.fragment.FragmentTab1;
import com.webviewdemo.fragment.FragmentTab2;
import com.webviewdemo.fragment.FragmentTab3;
import com.webviewdemo.fragment.FragmentTab4;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void fragmentCallBackForFinishActivity() {
        navitionFragment1.setFinishActivity(new FinishActivityInterface() {
            @Override
        ...
        navitionFragment4.setFinishActivity(new FinishActivityInterface() {
            @Override
            public void finishActivity() {
                finish();
            }
    ...
    private void initBottomViewStatus(int i) {
        mNavigationImg1.setImageResource(R.mipmap.my_normal);
        mNavigationImg2.setImageResource(R.mipmap.my_normal);
        mNavigationImg3.setImageResource(R.mipmap.my_normal);
        mNavigationImg4.setImageResource(R.mipmap.my_normal);
        ...
        switch (i) {
            case 0:
                mNavigationImg1.setImageResource(R.mipmap.message_select);
                mNavigationTv1.setTextColor(getResources().getColor(R.color.navigition_press));
                break;
            case 1:
                mNavigationImg2.setImageResource(R.mipmap.message_select);
                mNavigationTv2.setTextColor(getResources().getColor(R.color.navigition_press));
                break;
            case 2:
                mNavigationImg3.setImageResource(R.mipmap.message_select);
                mNavigationTv3.setTextColor(getResources().getColor(R.color.navigition_press));
                break;
            case 3:
                mNavigationImg4.setImageResource(R.mipmap.message_select);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (getVisibleFragment() instanceof FragmentTab1) {
            navitionFragment1.onKeyDown(keyCode, event);
            return true;
        }
        ...
        if (getVisibleFragment() instanceof FragmentTab4) {
            navitionFragment4.onKeyDown(keyCode, event);
            return true;
        }
